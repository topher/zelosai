...
import { getSubscriptionByUserId, updateSubscriptionCredits } from '../lib/subscription';
...
const mockedGetSubscriptionByUserId = getSubscriptionByUserId as jest.Mock;
