...
import Portal from '@/app/components/atomic/molecules/Portal';
import Loader from '@/app/components/atomic/atoms/Loader';
import ImageCard from '@/app/components/atomic/atoms/ImageCard';
  ...
  return (
    <div className="w-full h-full flex">
      ...
      <div className="flex-1 transition-all ease-in-out z-0">
        ...
        const imageUrl = '/3dicons/chat-bubble/chat-bubble-dynamic-premium.png';  // Use a placeholder image if `thumbnail` is missing
